	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					Add <code>flush</code> attribute to remove some borders and rounded corners to
	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					Add <code>horizontal</code> prop to change the layout of list group items from
		...
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					...
					needed. You can use them without <code>&lt;label&gt;</code>s, but please
					remember to include an <code>aria-label</code> attribute and value for
					accessibility.
				</p>
