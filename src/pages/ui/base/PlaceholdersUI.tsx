		...
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-13">
					...
					parent element. Customize them with sizing props: <code>lg</code>,
	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-13">
					Create placeholders with the <code>Placeholder</code> component and a grid
					column prop (e.g., <code>xs={6}</code>) to set the <code>width</code>. They can
					replace the text inside an element or be added to an existing component via the
					<code>as</code> prop.
				</p>
		...
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-13">
					...
					<code>glow</code> or <code>wave</code> to better convey the perception of
