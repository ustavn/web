		...
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					You can use <code>DropdownButton</code> to create a simple dropdown. Also, you
					can use prop <code>as</code> to create custom element typeof dropdown.
				</p>
	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					Add <code>.dropdown-menu-animated</code> to a <code>Dropdown.Menu</code> to have
		...
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					...
					utilities. Note that you’ll likely need additional sizing styles to constrain
					the menu width.
				</p>
		...
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					...
					margin or padding utilities to give it the negative space you require.
				</p>
