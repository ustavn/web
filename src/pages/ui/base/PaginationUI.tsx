		...
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					...
					prop for links that appear un-clickable and <code>active</code> prop to indicate
					the current page.
				</p>
				<Pagination>
	...
	return (
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					Add <code>lg</code> or <code>sm</code> type to <code>size</code> prop for
					additional sizes.
				</p>
		...
		<Card>
			<Card.Body>
				...
				<p className="text-muted font-14">
					...
					for adding "First", "Previous", "Next", and "Last" buttons, as well as an
